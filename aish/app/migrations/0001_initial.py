# Generated by Django 3.2.3 on 2021-10-09 09:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_label', models.TextField(blank=True)),
                ('author', models.TimeField(blank=True)),
                ('brand', models.CharField(max_length=100)),
                ('category', models.CharField(choices=[('M', 'Mobile'), ('L', 'Laptop'), ('TW', 'Top Wear'), ('BW', 'Bottom Wear'), ('APP', 'Appliances'), ('ESS', 'Essentials'), ('BT', 'Books and Toys')], max_length=4)),
